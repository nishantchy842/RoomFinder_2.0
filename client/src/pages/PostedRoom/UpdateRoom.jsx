...
const UpdateRoom = () => {
  ...
  const handleSubmit = async () => {
    ...
    const response = await axios.put(
      `${import.meta.env.VITE_APP_URL}/api/room/update/${state}`,
      bodyFormData,
      {
          ...
          {
            {
              ...
              2: (
                <div>
                  ...
                  <div className="mb-3 w-[75vw] flex flex-wrap flex-shrink-0 gap-3">
                    {images &&
                      images.map((item, id) => {
                        return (
