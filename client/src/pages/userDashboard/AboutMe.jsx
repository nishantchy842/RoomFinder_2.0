  ...
  const handleUpdate = async () => {
    try {
      const { data } = await axios.patch(
        `${import.meta.env.VITE_APP_URL}/api/auth/updateProfile`,
        {
          name,
          address,
          phone,
    ...
    <div className="about-me-container h-[80vh]">
      {users && (
        <div className="profile-dashboard-card">
          {!users.profile ? (
            <div className=" z-10">
              <img src={userProfile} alt="user" width={200} height={200} />
            </div>
          ) : (
            <img
              src={`${
          ...
          <button
            className="profile-dashboard-card-button"
            onClick={handleOpen}
          >
            Edit Profile
          </button>
          <div className="profile-dashboard-card-body z-10">
