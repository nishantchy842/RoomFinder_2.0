...
const DetailsRoom = ({ item }) => {
  ...
  return (
    <div className={`${styles.padding} w-full min-h-[70vh] shadows lg:w-[55%]`}>
        ...
        <Box sx={{ flexGrow: 1, flexWrap: "wrap" }}>
          <Grid container spacing={2}>
            <Grid
              item
              xs={9}
              className={`${styles.heroSubText} text-primary capitalize underline`}
            >
              {item?.title}
            </Grid>
            <Grid
            ...
            <Grid
              item
              xs={8}
              className={`${styles.sectionSubText} text-primary capitalize`}
            >
              <p>
                {" "}
                <strong>Address:</strong> {place?.place_name}
              </p>
            </Grid>
          </Grid>
        </Box>
      ...
      <div>
        <p
          className={`${styles.heroSubText} ${styles.paddingY} underline text-primary capitalize`}
        >
          Description
        </p>
        <p
          className={`${styles.sectionSubText} ${styles.paddingX} border-b-2 text-primary capitalize mb-20`}
        >
          {" "}
          {item.description}
        </p>
      ...
      <div className="Amenities flex flex-col text-white ">
        ...
        <div
          className={`${styles.sectionSubText} flex flex-wrap border-b-2 capitalize mb-20`}
        >
