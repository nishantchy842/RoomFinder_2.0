            ...
            >
                {
                    <Box sx={style}>
                        {
                            roomDetails?.room == null ? "Might be deleted by the landload" :
                                <div>
                                    <Typography id="modal-modal-description" sx={{ mt: 2 }}>
                                        ...
                                        >
                                            ...
                                            {
                                                roomDetails?.room?.img_collection.map((item) => {
                                                    return (
                                                        <div key={item}>
                                    ...
                                    <Typography id="modal-modal-title" variant="h6" component="h6" className='capitalize'>
                                        ...
                                        {
                                            roomDetails?.room?.amenities.map((item) => {
                                                return <p key={item} className=" m-2"> {item}</p>
                                            })
                                        }
                                    </Typography>
                                </div>
