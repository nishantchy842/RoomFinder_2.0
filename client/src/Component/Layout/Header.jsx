...
const Header = () => {
  ...
  return (
    <div className="shadow-md w-full fixed top-0 left-0 z-20 bg-zinc-100">
      ...
      text-gray-800"
        ...
        <ul
          className={`md:flex md:items-center md:pb-0 pb-12 absolute md:static text-gray-800 hover:text-blue-500 duration-500" bg-gray-100 md:z-auto z-[-1] left-0 w-full md:w-auto md:pl-0 pl-9 transition-all  hover:bg-gray-200 duration-500 ease-in ${open ? "top-20 " : "top-[-490px]"
            }`}
        >
          {Links.map((link) => (
