...
const { userRegister, userPostLogin, getSingleUser, totalUsers, recentUsers, updateProfile, PostGetOtp, getAllUser, deleteUser } = require('../controllers/userController')
